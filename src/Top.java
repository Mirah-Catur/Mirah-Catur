...
public class Top extends javax.swing.JFrame {
    ...
    private void panelNextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNextMouseClicked
        ...
        try {
            ...
            String simpan = "insert into tb_orderTop (Username, Kode, ShoulderWidth, Chest, Waist, Length, Hip) values( '"+Username+"','A','"+txtShoulderWidth.getText()+"','"+txtChest.getText()+"','"+txtWaist.getText()+"','"+txtLength.getText()+"','"+txtHip.getText()+"');";
            st= con.createStatement();
