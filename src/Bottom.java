...
public class Bottom extends javax.swing.JFrame {
    ...
    private void panelNextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNextMouseClicked
        ...
        try {
            ...
            String simpan = "insert into tb_orderBottom (Username, Kode, Waist, Hip, Length, Bottom, Model, Note, TotalPayment, OrderStatus, PaymentStatus) values( '"+Username+"','B','"+txtWaist.getText()+"','"+txtHip.getText()+"','"+txtLength.getText()+"','"+txtBottom.getText()+"','0','0','0','To be processed', 'Unpaid');";
            st= con.createStatement();
