 ...
 * @author user
 */
public class PesananUser extends javax.swing.JFrame {
    public static Connection con = null; 
    public static Statement st = null; 
    public static ResultSet rs;
    /**
     * Creates new form PesananUser
     */
    public PesananUser() {
        initComponents();
    ...
    private void initComponents() {
        ...
        labelDashboard.setText("Orders From Customer");
        ...
        tableOrder.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ORDER ID", "USERNAME", "SHOULDER WIDTH", "CHEST", "WAIST", "LENGTH", "HIP"
            }
        ));
    ...
    private void buttonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonInsertActionPerformed
        ...
        try{
            ...
            con.createStatement().executeUpdate("insert into tb_order (Username, ShoulderWidth, Chest, Waist, Length, Hip) values('"+txtUsername.getText()+"','"+txtShoulderWidth.getText()+"','"+txtChest.getText()+"','"+txtWaist.getText()+"','"+txtLength.getText()+"','"+txtHip.getText()+"');");
            tampiltabel();
        }
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        ...
        try{
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/db_tubespbo", "root", "");
            con.createStatement().executeUpdate ("delete from tb_order where OrderId= '"+txtOrderId.getText()+"';"); 
            tampiltabel();
        }
        catch(SQLException ex){
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        try{
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/db_tubespbo", "root", "");
            con.createStatement().executeUpdate ("update tb_order set OrderId= '"+txtOrderId.getText()+"', Username='"+txtUsername.getText()+"', ShoulderWidth= '"+txtShoulderWidth.getText()+"', Chest= '"+txtChest.getText()+"', Waist= '"+txtWaist.getText()+"', Length= '"+txtLength.getText()+"', Hip= '"+txtHip.getText()+"' where OrderId= '"+txtOrderId.getText()+"';"); 
            tampiltabel();
        }
        catch(SQLException ex){
            JOptionPane.showMessageDialog(null,"Incorrect Order Id");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesananUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesananUser().setVisible(true);
            }
        });
    }
    ...
    private void tampilkan(){
        ...
        try{
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/db_tubespbo", "root", "");
            ResultSet rs= con.createStatement(). executeQuery("select*from tb_order");
            while(rs.next()){
